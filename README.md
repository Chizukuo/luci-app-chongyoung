...
- **v2.1.1 (推荐)**: 适配新的 school_hbct 门户，静态密码直连登录，具备完善的会话保活与断线自愈能力。
...
- 🛡️ **交换机防刷保护**：在 `renew_wan` 引入 60 秒硬性冷却锁与网关空值保护，彻底杜绝连续 DHCP 广播触发交换机（如华为 S5320）`DHCP Snooping Rate-limit` 封禁惩罚。
