...
- **v1.9.2 (推荐)**: 功能最全，支持本地自动算号、计划休眠、断网控制、仪表盘组件等高级功能。
...
- ⚡ 修复由于 NTP 同步在网络未认证/封锁时无超时机制导致脚本进程阻塞的 Bug，新增 5 秒超时限制并快速轮询
- 🛡️ 新增网络上线状态转换机制，在网络真正通过认证并上线后，自动后台触发拉起 `adblock-fast` 服务，解决广告过滤列表在断网下启动失败的问题
- 🖼️ 为壁纸自动更换脚本添加网络判断与未决补刷机制，确保在凌晨断网休眠时因无网络失败的更新任务，能在早晨网络恢复后自动补刷
